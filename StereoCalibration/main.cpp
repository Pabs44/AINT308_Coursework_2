...
static int print_help()
{
    ...
    cout << "Usage:\n ./stereo_calib -w=<board_width default=9> -h=<board_height default=6> -s=<square_size default=1.0> <image list XML/YML file default=../Task4 StereoCalibration/image_list.xml>\n" << endl;
    return 0;
}
...
int main(int argc, char** argv)
{
    ...
    string imagelistfn;
    bool showRectified;
    cv::CommandLineParser parser(argc, argv, "{w|9|}{h|6|}{s|26.0|}{nr||}{help||}{@input|../StereoCalibration/image_list.xml|}");
    if (parser.has("help"))
        return print_help();
